...
def export(link, root, recursion_way):
    ...
    for dirpath, dirnames, filenames in os.walk(recursion_way):
        for dirname in dirnames:
            ...
            for fltr in os.listdir(current_path):
                try:
                    if ".docx" in fltr:
                        full_text1 = []
                        full_text2 = []
                        path2 = current_path + '/' + fltr
                        ...
                        if len(document.paragraphs[0].text.split(' \n')) == 3:
                            ...
                            print(f'Не попавшее в загрузку: {fltr}')
                    ...
                    print(f"ValueError Необработанный документ: {fltr}")
                except IndexError:
                    print(f"IndexError Необработанный документ: {fltr}")
                else:
                    pass
    file.close()
    quit()
